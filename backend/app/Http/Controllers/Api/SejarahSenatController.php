...
class SejarahSenatController extends Controller
{
    ...
    public function show(Request $request, $id = 0)
    {
        ...
        if ($id > 0) {
            $data = SejarahSenat::singleRow($id);

            return $this->successResponse($data);
        }

        $data = SejarahSenat::list();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $saveName = '/img/sejarah-senat/' . $fileName;
            $destinationPath = public_path('/img/sejarah-senat');
            ...
            if (isset($fileName) && is_file($fileName) && file_exists($fileName)) {
                unlink(public_path('/img/sejarah-senat') . $fileName);
            }
