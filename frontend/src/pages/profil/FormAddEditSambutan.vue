...
watch(
  ...
  () => {
    if (sambutanStore.isSuccessSubmit)
    {
      snackbar.add({
        type: 'success',
        text: "Sambutan Berhasil di Simpan",
      })
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" id="name" class="form-control" placeholder="Isi Nama Ketua Senat"
                v-model="sambutanForm.namaKetuaSenat" required />
            </div>
            <div class="form-group">
              <label for="input">Judul</label>
              <input type="text" id="title" class="form-control" placeholder="Isi Judul Disini"
                v-model="sambutanForm.judul" required />
            </div>
          </div>
          <div class="form-group col-md-12">
            <label>Sambutan Ketua Senat</label>
            <textarea class="form-control" rows="4" placeholder="Isi Sambutan Ketua Senat" v-model="sambutanForm.isi">
            </textarea>
          </div>
        </div>
