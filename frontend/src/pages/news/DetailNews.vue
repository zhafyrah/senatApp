...
watch(
  ...
  () => {
    ...
    {
      fotoUrl.value = import.meta.env.VITE_BASE_URL + beritaStore.beritaSingleData.foto_path
    }
  }
)
  ...
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
          <div class="row">
            <div class="col-12">
              ...
              <span class="description">Diunggah - {{ beritaData.created_at }}</span>
            </div>
          </div>
          <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2 d-flex justify-content-end">
