    ...
    <form class="form" @submit.prevent="onClickSubmit">
      <div class="card-body">
        <div class="form-group">
          <label>Komisi</label>
          <select class="form-control" v-model="fungsiKerjaForm.komisi" required>
        ...
        <div class="form-group">
          ...
          <div class="form">
            <input type="text" class="form-control" placeholder="Ketua Komisi" v-model="fungsiKerjaForm.ketuaKomisi" required/>
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail">Anggota 1</label>
          <div class="form">
            <input type="text" class="form-control" placeholder="Nama Anggota 1" v-model="fungsiKerjaForm.anggota1" />
          </div>
        </div>
        <div class="form-group">
          <label for="inputName">Anggota 2</label>
          <input type="text" class="form-control" placeholder="Nama Anggota 2" v-model="fungsiKerjaForm.anggota2"/>
        </div>
        <div class="form-group">
          <label for="input">Anggota 3</label>
          <input type="text" class="form-control" placeholder="Nama Anggota 3" v-model="fungsiKerjaForm.anggota3"/>
        </div>
        <div class="form-group">
          <label for="inputContent">Fungsi Kerja</label>
          <textarea class="form-control" rows="3" placeholder="Fungsi Kerja" v-model="fungsiKerjaForm.fungsiKerja"></textarea>
        </div>
      </div>
