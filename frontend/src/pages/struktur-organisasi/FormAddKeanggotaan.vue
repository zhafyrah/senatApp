        ...
        <form class="form-user" @submit.prevet="onClickSubmit">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="form">
                        <input type="text" class="form-control" placeholder="Silahkan Isi Nama"
                            v-model="keanggotaanForm.nama" required />
                    </div>
                </div>
                <div class="form-group">
                    <label>Jabatan</label>
                    <div class="form">
                        <input type="text" class="form-control" placeholder="Silahkan Isi Jabatan"
                            v-model="keanggotaanForm.jabatan" required />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail">Pendidikan</label>
                    <div class="form">
                        <input type="text" class="form-control" placeholder="Silahkan Isi Pendidikan"
                            v-model="keanggotaanForm.pendidikan" required />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="exampleInputFile">
                                {{ fotoFile == null ? "Temukan Dokumen dari Komputer Anda" : fotoFile.name }}
                            </label>
                        </div>
